			...
			<div class="row">
				<div class="form-group col-md-12">
					<div class="col-md-7">
						<c:choose>
							<c:when test="${edit}">
								<form:input type="text" path="name" placeholder="Username" id="name" class="form-control input-sm" disabled="true"/>
							</c:when>
							<c:otherwise>
								<form:input type="text" path="name" placeholder="Username" id="name" class="form-control input-sm" />
								<div class="has-error">
